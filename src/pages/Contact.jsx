...
const Contact = () => {
    const contactInfo = {
        ...
        linkedin: "linkedin.com/in/murali-sai-srinivas",
        github: "github.com/Itachi3355"
    };

    return (
        <div className="flex flex-col items-center h-full p-6 bg-gray-800 text-white">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <a href={`https://${contactInfo.linkedin}`} target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <a href={`https://${contactInfo.github}`} target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">
                                    {contactInfo.github}
                                </a>
                            </div>
                        </div>
